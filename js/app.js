(() => {
    ...
    da.init();
    const itemCloseBlock = document.querySelector(".header__top");
    document.addEventListener("click", closeBlock);
    function closeBlock(e) {
        const targetItem = e.target;
        if (targetItem.closest(".header__top span")) itemCloseBlock.classList.add("_active");
        if (targetItem.closest(".what-we-do__media")) {
            const videoBlock = document.querySelector("video");
            videoBlock.setAttribute("autoplay", "");
        }
    }
    window["FLS"] = true;
    isWebp();
